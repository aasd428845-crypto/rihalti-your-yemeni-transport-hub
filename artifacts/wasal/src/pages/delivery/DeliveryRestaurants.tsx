            ...
            <Card key={r.id} className="overflow-hidden hover:shadow-md transition-shadow group">
              ...
              <CardContent className={`p-4 space-y-3 ${r.logo_url ? "pt-10" : ""}`}>
                ...
                <div className="flex items-center gap-3 text-xs text-muted-foreground">
                  ...
                  <span className="flex items-center gap-1"><Truck className="w-3 h-3" />{r.price_per_km ? `${r.price_per_km} ر.ي/كم` : "—"}</span>
                </div>
                {r.city ? (
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <div className="flex items-start gap-1.5 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-900/50 rounded-lg px-3 py-2 text-xs text-blue-700 dark:text-blue-400">
                    ...
                    <div className="space-y-0.5">
                      <p className="font-semibold">900 × 400 بكسل (نسبة 9:4)</p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <Label className="flex items-center gap-1">
                  سعر التوصيل بالكيلومتر (ر.ي)
                  <span className="text-xs text-muted-foreground font-normal">— مثال: 250 ر.ي/كم</span>
                </Label>
                <Input type="number" value={form.price_per_km} onChange={e => setForm({...form, price_per_km: Number(e.target.value)})} placeholder="250" />
              </div>
              <div className="sm:col-span-2">
