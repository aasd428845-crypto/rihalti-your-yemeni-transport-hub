  ...
  <div className="container mx-auto px-4 py-10 max-w-3xl" dir="rtl">
    ...
    <div className="space-y-8">
      ...
      <Section num="١" title="من نحن">
        <p>وصال هي منصة يمنية متخصصة في خدمات التوصيل والنقل، تشمل توصيل الطرود والشحنات، وطلب سيارات الأجرة، وتوصيل الطلبات من المطاعم والمتاجر داخل اليمن. نتخذ من اليمن مقراً لنا ونلتزم بالقوانين اليمنية المعمول بها.</p>
      </Section>
      ...
      <Section num="٢" title="البيانات التي نجمعها">
        ...
        <ul className="list-disc list-inside space-y-1.5 mr-2">
          ...
          <li><strong>بيانات الموقع:</strong> موقعك عند طلب خدمة التوصيل أو الأجرة (بإذنك فقط)</li>
