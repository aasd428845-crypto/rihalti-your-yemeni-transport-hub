...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      base: basePath,
      includeAssets: ["favicon.ico", "favicon.png", "favicon.svg", "icons/icon-192x192.png", "icons/icon-512x512.png"],
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            urlPattern: /^https:\/\/hhqhoqwpebnmfuhwhllw\.supabase\.co\/rest\/.*/i,
