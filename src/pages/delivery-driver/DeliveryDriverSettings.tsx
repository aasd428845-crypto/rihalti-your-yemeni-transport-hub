...
const DeliveryDriverSettings = () => {
  ...
  const toggleItems = [
    ...
    { key: "notify_delivery_updates", label: "إشعارات التوصيل", icon: Bell },
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader><CardTitle className="text-lg">إعدادات الإشعارات</CardTitle></CardHeader>
...
export default DeliveryDriverSettings;
