import { Smartphone, Clock, Heart, Headphones, Star } from "lucide-react";
  ...
  return (
    <section className="py-20 bg-card">
      <div className="container mx-auto px-4">
        <div className="bg-gradient-to-br from-primary to-secondary rounded-3xl p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
            <div className="text-primary-foreground">
              ...
              <h2 className="text-3xl md:text-4xl font-black mb-4">حمّل تطبيق وصل الآن</h2>
              ...
              <div className="flex flex-wrap gap-3">
                <Button size="lg" className="bg-accent text-accent-foreground font-bold hover:bg-accent/90 shadow-lg">
                  Google Play
                </Button>
              ...
              <div className="w-64 h-[500px] bg-white/10 rounded-[2.5rem] border-4 border-white/20 flex flex-col items-center pt-8 px-4 relative overflow-hidden">
                ...
                <div className="w-full space-y-3">
                  ...
                  <div className="bg-white/10 rounded-xl p-3 flex justify-between items-center">
                    ...
                    <span className="text-xs text-accent">5,000 ريال</span>
                  </div>
                  <div className="bg-white/10 rounded-xl p-3 flex justify-between items-center">
                    <span className="text-xs text-primary-foreground/80">10:00 ص</span>
                    <span className="text-xs text-accent">6,000 ريال</span>
                  </div>
                </div>
